...
export default function FooterOne() {
  ...
  return (
    <footer className="footer -type-1 bg-light-6 -green-links">
      <div className="container">
        <div className="footer-header">
          <div className="row y-gap-20 justify-between items-center">
            <div className="col-auto">
              <div className="footer-header__logo imgsha">
          ...
          <div className="row justify-between items-center y-gap-20">
            <div className="col-auto">
              <div className="d-flex items-center h-100 text-white">
                © {new Date().getFullYear()} NeetSupport. All Right Reserved.
              </div>
            </div>
            ...
            <div className="col-auto">
              <div className="d-flex x-gap-20 y-gap-20 items-center flex-wrap">
                ...
                <div>
                  <Link
                    to="#"
                    className="button px-30 h-50 -orange-1 rounded-200 text-white"
                  >
