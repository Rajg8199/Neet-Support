        ...
        <div className="row justify-center text-center">
          <div className="col-auto">
            <div className="sectionTitle ">
              <h2 className="sectionTitle__title ">Top Colleges</h2>
          ...
          {topCatagoriesFour.map((elm, i) => (
            ...
            >
              <div className="categoryCard -type-3">
                <div className="categoryCard__icon no-background mr-20">
                  {/* <i className={elm.iconClass}></i> */}
                  <img src={elm.iconSrc} alt={elm.title} className="icon-svg" />
                </div>
