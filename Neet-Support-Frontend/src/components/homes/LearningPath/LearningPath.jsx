          ...
          <div className="col-auto">
            <div className="sectionTitle ">
              <h2 className="sectionTitle__title ">
                Navigating your <span className="text-orange-1">Journey Together</span>
              </h2>

              <p className="sectionTitle__text ">
              "Navigating aspiring doctors from NEET Counselling through Admission and beyond, our mentors provide continuous support."
              </p>
            </div>
          </div>
        </div>
