export const menuList = [
    ...
    links: [
      {
        ...
        // links: [
        //   { href: "/courses-list-8", label: "Course List" },
        // ],
      },
      {
        // title: "Course Single Layouts",
        // links: [
        //   { href: "/courses-single-5/4", label: "Course Single" },
      ...
      },
      {
        // title: "About Courses",
        // links: [
        //   { href: "/lesson-single-1", label: "Lesson Page" },
        //   { href: "/instructors-list-1", label: "Instructors List" },
  ...
  {
    title: "Blogs",
    links: [{ href: "/blog-list-2", label: "Blog List 2" }],
  },
  {
    title: "Pages",
    links: [
