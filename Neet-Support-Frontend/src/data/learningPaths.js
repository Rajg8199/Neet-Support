...
export const learningPathTwo = [
  {
    ...
    text: "Choose from our top-notch services to start your journey with us.",
    bgColor: "bg-green-3",
  },
  {
    id: 2,
    ...
    text: "Receive personalized assistance for document verification.",
    bgColor: "bg-yellow-2",
  },
  {
    id: 3,
    ...
    text: "Pick the best college from your list of eligible options.",
    bgColor: "bg-blue-2",
  },
  {
    id: 4,
    icon: "/assets/img/home-4/learning/2.svg",
    title: "Acheive Your Goal",
    text: "Secure admission to the college of your dreams.",
    bgColor: "bg-orange-3",
  },
];
...
export const learningJourney = [
  {
    ...
    text: "Receive personalised guidance from experienced NEET counsellors.",
    delay: 1,
  },
  {
    id: 2,
    ...
    text: "Get step-by-step support through the entire NEET counselling process.",
    delay: 2,
  },
  {
    id: 3,
    ...
    text: "Access our counselling services anytime, anywhere.",
    delay: 3,
  },
  {
    id: 4,
    ...
    text: "Stay informed of the latest updates and changes in NEET counseling.",
    delay: 4,
  },
];
