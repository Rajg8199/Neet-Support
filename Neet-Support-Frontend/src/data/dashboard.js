export const states = [
  {
    id: 1,
    name: "Sr. Mentor",
    sessions: "100+ sessions taken",
    description:
      "Mr. Shalin P S has helped 250+ students enter their dream medical college.",
    img: "/assets/img/dashboard/mentor/1.webp",
  },
  {
    id: 2,
    name: "Jr. Mentor",
    sessions: "50+ sessions taken",
    description:
      "Jr. Mentor has guided many students towards achieving their academic goals.",
    img: "/assets/img/dashboard/mentor/2.webp",
  },
  {
    id: 3,
    name: "Academic",
    sessions: "200+ sessions taken",
    description:
      "Academic Mentor specializes in providing top-notch academic guidance.",
    img: "/assets/img/dashboard/mentor/3.webp",
  },
  {
    id: 4,
    name: "Success Coach",
    sessions: "150+ sessions taken",
    description:
      "Success Coach helps students to strategize and succeed in their careers.",
    img: "/assets/img/dashboard/mentor/4.webp",
  },
];
...
export const news = [
  {
    id: 1,
    title: "Register yourself for basic counseling webinar",
    description: "This will help you to understand us and our services",
  },
  {
    id: 2,
    title: "Register yourself for basic counseling webinar",
...
export const upcomingWebinar = {
  date: "18 Jun 2024",
  time: "10:30 AM",
  title: "How to fill and choice filling of MCC portal",
  description:
    "Join us for an informative webinar on “Navigating the MCC Portal: A Step-by-Step Guide to Filling and Choice Filling”.",
